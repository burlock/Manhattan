				...
				<div class="col-md-3">
					<div id="sidebar-navigation-list" class="bs-sidebar hidden-print affix-top" role="complementary">
						<ul class="nav bs-sidenav">
							<?php
							include $_SERVER['DOCUMENT_ROOT'] . '/common/code/de/leftMenus.php';
							?>
						</ul> <!-- class="nav bs-sidenav" -->
					...
					<div class="bs-docs-section">
						...
						if(($userRow['profile'] == 'Administrador') || ($userRow['profile'] == 'SuperAdmin')){
							...
							if((getDBrowsnumber('cvitaes') == 0) || ($pendingCVs == 0)){
								echo "<h1 class='page-header'><small>Keine Lebensläufe zu bearbeiten.</small></h1>";
							}
							else{
								echo "<h2><small>Es gibt <a href=./home/pendingCVs.php>" . $pendingCVs . " </a> Zu bearbeitende Lebensläufe. </small></h2><br>";
							}
						...
						//Conditional block for any other profile (which in fact is only 'Candidato')
							...
							echo "<h1 class='page-header'>Geben Sie Ihren Lebenslauf ein ... <small>" . $userRow['login'] . "</small></h1>";
							include 'upload.php';
						}
