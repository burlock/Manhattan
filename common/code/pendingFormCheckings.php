			...
			switch ($userRow['language']){
				case 'german':
					...
					<script type="text/javascript">
						...
						window.location.href='/de/home/pendingCVs.php?codvalue=<?php echo $_POST['eCCVnie'];  ?>';
					</script>
					<?php 
				break;
				...
				case 'english':
					...
					<script type="text/javascript">
						...
						window.location.href='/en/home/pendingCVs.php?codvalue=<?php echo $_POST['eCCVnie'];  ?>';
					</script>
					<?php 
				break;
				...
				default:
					...
					<script type="text/javascript">
						...
						window.location.href='/es/home/pendingCVs.php?codvalue=<?php echo $_POST['eCCVnie'];  ?>';
					</script>
					<?php 
				break;
			}
