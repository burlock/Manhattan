								...
								<div class="container-fluid center-block">
									...
									<form class="form-inline" role="form" name="newLanguage" action="admGenOptions.php" method="post">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="newLangenName" maxlength="50" placeholder="English Name" />
										</div>							
										<div class="form-group">
											<label class="sr-only" for="newLangesName">Spanish Name</label>
											<input type="text" class="form-control" name="newLangesName" maxlength="50" placeholder="Spanish Name" />
										</div>
										<div class="form-group">
											<label class="sr-only" for="newLangdeName">German Name</label>
											<input type="text" class="form-control" name="newLangdeName" maxlength="50" placeholder="German Name" />
										</div>	
								...
								<div class="container-fluid center-block">
									...
									<form class="form-inline" role="form" name="newCareer" action="admGenOptions.php" method="post">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="newCareerenName" maxlength="100" placeholder="English Name" />
										</div>							
										<div class="form-group">
											<label class="sr-only" for="newCareeresName">Spanish Name</label>
											<input type="text" class="form-control" name="newCareeresName" maxlength="100" placeholder="Spanish Name" />
										</div>
										<div class="form-group">
											<label class="sr-only" for="newCareerdeName">German Name</label>
											<input type="text" class="form-control" name="newCareerdeName" maxlength="100" placeholder="German Name" />
										</div>	
									...
									<div class="container-fluid center-block">
										...
										<form class="form-inline" role="form" name="newOption" action="admGenOptions.php" method="post">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="newOptionKey" size="6" maxlength="50" placeholder="Key" />
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="newOptionComment" maxlength="200" placeholder="Comment" />
											</div>
											<div class="form-group">
