...
if (!$_SESSION['loglogin']){
	...
	if($villageSet->count() > 1){
		echo '<label id="uploadFormLabel" class="control-label col-sm-2" for="blankaddrcity" style="padding-right: 10px;">City: </label><select class="form-control" name="blankaddrcity" id="blankaddrcity" style="margin-top:5px; width:60%">';
			echo'<option>Your city...</option>';
