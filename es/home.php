				...
				<div class="col-md-3">
					<div id="sidebar-navigation-list" class="bs-sidebar hidden-print affix-top" role="complementary">
						<ul class="nav bs-sidenav">
							<?php
							include $_SERVER['DOCUMENT_ROOT'] . '/common/code/es/leftMenus.php';
							?>
						</ul> <!-- class="nav bs-sidenav" -->
					...
					<div class="bs-docs-section">
						...
						if(($userRow['profile'] == 'Administrador') || ($userRow['profile'] == 'SuperAdmin')){
							...
							if((getDBrowsnumber('cvitaes') == 0) || ($pendingCVs == 0)){
								echo "<h1 class='page-header'><small>No existen CVs por revisar.</small></h1>";
							}
							else{
								echo "<h2><small>Existen <a href=./home/pendingCVs.php>" . $pendingCVs . " </a> CVs por revisar. </small></h2><br>";
							}
