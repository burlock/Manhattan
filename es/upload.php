				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="form-group"> <!-- Nombre -->
							...
							<div class="col-sm-10">
								<input class="form-control" type='text' name='blankname' minlength='3' maxlength='50' placeholder="Min. 3 caracteres" value="<?php echo $cvRow['name'] ?>" required/>
							</div>
						</div>
						...
						<div class="form-group"> <!-- Apellidos -->
							...
							<div class="col-sm-10">
								<input class="form-control" type='text' name='blanksurname' maxlength='50' placeholder="Min. 3 caracteres" value="<?php echo $cvRow['surname'] ?>" required/>
							</div>
						</div>
						...
						<div class="form-group tooltip-demo"> <!-- Sexo & Nacionalidad -->
							...
							<div class="col-sm-3">
								<div class='radio-inline'>
									<?php 
									if($cvRow['sex'] == 0){
										echo "<label id='noPadding' class='radio-inline'><input class='radio-inline' type='radio' name='blanksex' value='".$cvRow['sex']."' required checked='checked'>Hombre</label>";
										echo "<label id='noPadding' class='radio-inline'><input class='radio-inline' type='radio' name='blanksex' value='".$cvRow['sex']."' >Mujer</label>";
									}
									else{
										echo "<label id='noPadding' class='radio-inline'><input class='radio-inline' type='radio' name='blanksex' value='".$cvRow['sex']."' required>Hombre</label>";
										echo "<label id='noPadding' class='radio-inline'><input class='radio-inline' type='radio' name='blanksex' value='".$cvRow['sex']."' checked='checked'>Mujer</label>";
									}
									?>
								</div>
							</div>
						
							<label id="uploadFormLabel" class="control-label col-sm-2" for="add_nat"><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-original-title="Si tiene más de una, seleccione todas mientras pulsa la tecla'CTRL'"></span> Nacionalidad: * </label> 
							...
							<div class="btn-toolbar col-sm-1">
								  ...
								  <div class="btn-group btn-group-sm"><button type="button" class="btn btn-default" onclick="addNationality(this.form);"><span class="glyphicon glyphicon-plus"></span></button></div>	
									...
									<?php 
									$cvNations = getDBcolumnvalue(keyCountry, userNationalities, userNIE, $cvRow['nie']);
									foreach ($cvNations as $i){
										//echo '<option value=' . $i . '>' . $i . '</option>';
										//echo "<div class='btn-group btn-group-sm'><button type='button' class='btn btn-default' onclick='addNationality($i);'><span class='glyphicon glyphicon-plus'></span></button></div>";
										//var savedNat = "<?php echo $i; ? >";
										?>
										<script type="text/javascript">
										var savedNat = "<?php echo $i; ?>";
										</script>
										<?php 
										echo "<div class='btn-group btn-group-sm'><button type='button' class='btn btn-default' onclick='addNationality(savedNat);'><span class='glyphicon glyphicon-plus'></span></button></div>";
									}
									?>
						...
						<div class="form-group">  <!-- Dirección -- >
							...
							<div class="col-sm-10 form-inline">
								...
								<input class="form-control form-inline" type="text" name="blankaddrname" size="30" maxlength="50" placeholder="Nombre" value="< ?php echo $cvRow['addrName'] ?>">
								...
								<input class="form-control form-inline" type="text" name="blankaddrstair" size="4" maxlength="4" placeholder="Esc" value="< ?php echo $cvRow['stair'] ?>" onkeyup="this.value=this.value.toUpperCase();">
								<input class="form-control form-inline" type="text" name="blankaddrfloor" size="2" maxlength="4" placeholder="Piso" value="< ?php echo $cvRow['addrFloor'] ?>">
								<input class="form-control form-inline" type="text" name="blankaddrdoor" size="4" maxlength="4" placeholder="Puerta" value="< ?php echo $cvRow['addrDoor'] ?>" onkeyup="this.value=this.value.toUpperCase();">
								<br><br>
	...
	echo '<label id="uploadFormLabel" class="control-label col-sm-2" for="blankaddrcountry" style="padding-right: 10px;">País: </label><input class="form-control" type="text" name="blankaddrcountry" size="20" value="España" readonly style="margin-top:5px;"><br>';
						...
						<div class="form-group"> <!-- Dirección -- >
							...
							<div class="col-sm-10 form-inline">
								...
								<div class="row">
									<div class="col-sm-6">
										<input class="form-control" type="text" name="blankaddrcity" placeholder='Localidad' />
									</div>
									<div class="col-sm-2">
										<input class="form-control" type="text" name="blankaddrpostalcode" placeholder='Cód.Postal' />
									</div>
								</div>
								<div class="row">
									<div class="col-sm-4">
										<input class="form-control" type="text" name="blankaddrprovince" placeholder='Provincia' />
									</div>
									<div class="col-sm-4">
										<input class="form-control" type="text" name="blankaddrcountry" placeholder='País' />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group"> <!-- Dirección -->
							...
							<div class="col-sm-10 form-inline">
								...
								<div class="row">
									<div class="col-sm-6">
										<input class="form-control form-inline" type="text" name="blankaddrcity" size="45" maxlength="50" placeholder="Localidad" value="<?php echo $cvRow[city] ?>">
									</div>
									<div class="col-sm-1">
										<input class="form-control form-inline" type="text" name="blankaddrpostalcode" size="25" maxlength="12" placeholder="Cód.Postal" value="<?php echo $cvRow[postalCode] ?>" onkeyup="this.value=this.value.toUpperCase();">
									</div>
								</div>
									
								<div class="row">
									<div class="col-sm-6">
										<input class="form-control form-inline" type="text" name="blankaddrprovince" size="45" maxlength="30" placeholder="Provincia" value="<?php echo $cvRow[province] ?>">
									</div>
									<div class="col-sm-1">
										<input class="form-control form-inline" type="text" name="blankaddrcountry" size="25" maxlength="30" placeholder="País" value="<?php echo $cvRow[country] ?>">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group"> <!-- Teléfono Móvil & Teléfono Adicional -->
							...
							<div class="col-sm-4">
								<input class="form-control" type="text" name="blankmobile" maxlength="18" placeholder="Ej. 0034-699000000" value="<?php echo $cvRow['mobile'] ?>" required onkeypress="return checkDashedNumbers(event)">
							</div>
							
							<label id="uploadFormLabel" class="control-label col-sm-2" for="blankphone">Otro teléfono: </label> 
							<div class="col-sm-4">
								<input class="form-control" type="text" name="blankphone" maxlength="18" placeholder="Ej. 0034-910000000" value="<?php echo $cvRow['phone'] ?>" onkeypress="return checkDashedNumbers(event)">
							</div>
						</div>
						...
						<div class="form-group"> <!-- Correo Electrónico -->
							...
							<div class="col-sm-10">
								<input class="form-control" type="email" name="blankmail" placeholder="correo@ejemplo.com" value="<?php echo $cvRow['mail'] ?>" required>
							</div>
						</div>		
						...
						<div class="form-group"> <!-- Estado Civil  & Hijos -->
							...
							<div class="col-sm-4">
								<select class="form-control" name="blankmarital">
									<option selected value="">Estoy...</option>
									<?php
									$userLang = getDBsinglefield('language', 'users', 'login', $_SESSION['loglogin']);
						...
						<div class="form-group"> <!-- Foto -->
							...
							<div class="col-sm-10">
								...
								<p class="help-block">Tipos admitidos: JPG, JPEG o PNG. Max: 1Mb</p>
							</div>
						</div>
			
						<div class="form-group tooltip-demo"> <!-- Archivos -->
							<!-- <label id="uploadFormLabel" class="control-label col-sm-2" ><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-original-title="Tipos admitidos: PDF, DOC, DOCX, XLS, XLSX, CSV, TXT o RTF. Max: 1Mb. Elija cuántos desee ayudándose de la tecla 'CTRL'"></span> Documentos adicionales: </label> -->
							<label id="uploadFormLabel" class="control-label col-sm-2" ><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-original-title="CV, Certificados, etc... Tipos admitidos: PDF, DOC, DOCX, XLS, XLSX, CSV, TXT o RTF. Max: 1Mb. Elija cuántos desee ayudándose de la tecla 'CTRL'"></span> Documentos adicionales: </label> 
						...
						<div class="form-group"> <!-- Salario -->
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="blanksalary" maxlength="7" placeholder="€ neto/año" value="<?php echo $cvRow['salary'] ?>" onkeypress="return checkOnlyNumbers(event)">
							</div>
						</div>
						...
						<div class="form-group"> <!-- Otros datos de Interés -->
							...
							<div class="col-sm-10">
								<textarea class="form-control" type="number" name="blankother" placeholder="Exponga aquí cualquier dato que estime oportuno y no aparezca en ningún otro campo..." value="<?php echo $cvRow['otherDetails'] ?>"></textarea>	
							</div>
						</div>		
						...
						<fieldset id="jsLanguage">
							...
							<div class="panel panel-default"> <!-- Educación -->
								<div class="panel-heading">
									...
									<h3 class="panel-title"><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-original-title="Incluya los títulos que tenga de la siguiente forma: Titulo y Especialidad, Centro de estudios, Fechas de inicio y fin"></span> Educación: *</label></h3>
								</div>
								...
								<table id="cvExperTable_1" align="center">
									<tbody>
										...
										<tr class="panel panel-default panel-body form-inline" id="clonable" style="display:none">
											...
											<td>
												<label id="uploadFormLabel" class="control-label col-sm-0" for="">Posiciónn: </label>
