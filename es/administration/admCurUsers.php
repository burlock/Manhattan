							...
							switch($_GET['hiddenGET']){
								case 'hDelUser':
									...
									if(!deleteDBrow('cvitaes', 'userLogin', getDBsinglefield('login', 'users', 'id', $_GET['codvalue']))){
										?>
										<script type="text/javascript">
											alert('Error al borrar el CV del Candidato.');
											window.location.href='admCurUsers.php';
										</script>
										<?php 
									}
										...
										if(!deleteDBrow('users', 'id', $_GET['codvalue'])){
											?>
											<script type="text/javascript">
												alert('Error al borrar los datos del Candidato.');
												window.location.href='admCurUsers.php';
											</script>
											<?php 
										}
								...
								case 'hResPwd':
									...
									if(!executeDBquery("UPDATE `users` SET `pass`='".$initialPass."', `active`='1', `needPass`='1', `passExpiration`='".$expirationDate."' WHERE `id`='".$userRow['id']."'")){
										...
										?>
										<script type="text/javascript">
											alert('Contraseña de Usuario reseteada con éxito. \nNueva contraseña: <?php echo $initialPass; ?>');
											window.location.href='admCurUsers.php';
										</script>
										<?php
									}
									...
									<div class="modal-content panel-info">
										...
										<form id="editedUser" class="form-horizontal" role="form" name="editedUser" autocomplete="off" method="post" action="admCurUsers.php">
											<div class="modal-body">
														...
														<div class="col-sm-2">
															...
															if($_SESSION['logprofile'] != 'SuperAdmin'){
																if(strpos($editedUserRow['login'], 'test') === false){
																	echo "<a class='btn btn-warning' href='admCurUsers.php?codvalue=" . $editedUserRow['id'] . "&hiddenGET=hResPwd' onclick=\"return confirmPwdReset('".getCurrentLanguage($_SERVER['SCRIPT_NAME'])."');\">Resetear</a>";
																}
															}
															else{
																echo "<a class='btn btn-warning' href='admCurUsers.php?codvalue=" . $editedUserRow['id'] . "&hiddenGET=hResPwd' onclick=\"return confirmPwdReset('".getCurrentLanguage($_SERVER['SCRIPT_NAME'])."');\">Resetear</a>";
												...
												<?php if($_SESSION[logprofile] == 'SuperAdmin'){ ?>
												<div class="form-group">
													<label id="editedUserLabel" class="control-label col-sm-2" for="eUprofile">Perfil: </label> 
													<div class="col-sm-10">
												...
												if($_SESSION[logprofile] == 'SuperAdmin'){ ?>
													<div class="form-group">
														<label id="editedUserLabel" class="control-label col-sm-2" for="eUemployee">Empleado: </label>
														<div class="col-sm-10">
															...
															<?php if($editedUserRow[employee] == 0){ ?>
																...
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUemployee" value="1">Si</label>
															<?php }
															else{ ?>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUemployee" value="0">No</label>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUemployee" value="1" checked>Si</label>
															<?php } ?>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<label id="editedUserLabel" class="control-label col-sm-2" for="eUshowing">Mostrando: </label>
														<div class="col-sm-10">
															<div class="radio-inline">
															<?php if($editedUserRow[showing] == 0){ ?>
																...
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUshowing" value="1">Ofertas</label>
															<?php }
															else{ ?>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUshowing" value="0">CV</label>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUshowing" value="1" checked>Ofertas</label>
															<?php } ?>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<label id="editedUserLabel" class="control-label col-sm-2" for="eUactive">Activo: </label>
														<div class="col-sm-10">
															<div class="radio-inline">
															<?php if($editedUserRow[active] == 0){ ?>
																...
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="1">Si</label>
															<?php }
															else{ ?>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="0">No</label>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="1" checked>Si</label>
															<?php } ?>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															...
															<?php if($editedUserRow[active] == 0){ ?>
																...
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="1" disabled>Si</label>
															<?php }
															else{ ?>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="0" disabled>No</label>
																<label id="noPadding" class="radio-inline"><input class="radio-inline" type="radio" name="eUactive" value="1" checked disabled>Si</label>
															<?php } ?>
															</div>
														</div>
													</div>
												<?php } ?>
												<div class="form-group">
													<label id="editedUserLabel" class="control-label col-sm-2" for="eUlanguage">Idioma: </label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													<label id="editedUserLabel" class="control-label col-sm-2" for="eUcreated">Creado: </label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													<label id="editedUserLabel" class="control-label col-sm-2" for="eUconnection">Última conexión: </label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													<label id="editedUserLabel" class="control-label col-sm-2" for="eUexpiration">Caduca password: </label>
													<div class="col-sm-10">
											...
											<div class="modal-footer">
												...
												if($_SESSION['logprofile'] != 'SuperAdmin'){
													if(strpos($editedUserRow['login'], 'test') === false){
														echo "<a href='admCurUsers.php?codvalue=" . $editedUserRow['id'] . "&hiddenGET=hResPwd' onclick=\"return confirmPwdReset('".getCurrentLanguage($_SERVER['SCRIPT_NAME'])."');\">Resetear contraseña</a>";
													}
												}
												else{
													echo "<a href='admCurUsers.php?codvalue=" . $editedUserRow['id'] . "&hiddenGET=hResPwd' onclick=\"return confirmPwdReset('".getCurrentLanguage($_SERVER['SCRIPT_NAME'])."');\">Resetear contraseña</a>";
									...
									<div class="panel-body">
										...
										<div class="container-fluid center-block">
											<form class="form-inline" role="form" name="newCand" action="admCurUsers.php" method="post">
												<div class="form-group">
													<b>Creación rápida de Candidato: </b><input type="text" class="form-control" name="newCmail" size="50%" maxlength="50" placeholder="Correo del candidato" />
												</div>
												<button type="submit" class="btn btn-primary" name="newQuickCsubmit" value="AñadirC">Crear Candidato</button>
											</form>
										</div>
												...
												<tbody>
													...
													foreach($userKeyRow as $i){
														...
														echo "<tr>";
															...
															echo "<td><a href='admCurUsers.php?codvalue=" . $showedUserRow['id'] . "&hiddenGET=hDelUser' onclick=\"return confirmUserDeletion('".getCurrentLanguage($_SERVER['SCRIPT_NAME'])."')\">Borrar</a></td>";
														echo "</tr>";
														$k++;
													}
													?>
							...
							elseif($_SESSION['logprofile'] == 'Administrador'){
								...
								<div class="panel panel-default"> <!-- Panel de Usuarios Existentes -->
									...
									<div class="panel-body">
										...
										<!-- DE MOMENTO PARA EL Administrador NO LO MUESTRO. SOLO PARA SuperAdmin Y LO MANTENDRÉ CAPADO
										<div class="container-fluid center-block">
											<form class="form-inline" role="form" name="newCand" action="admCurUsers.php" method="post">
												<div class="form-group">
													<b>Creación rápida de Candidato: </b><input type="text" class="form-control" name="newCmail" size="50%" maxlength="50" placeholder="Correo del candidato" />
