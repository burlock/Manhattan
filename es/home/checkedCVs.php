						...
						<div class="modal-content panel-info">
							...
							<form id="editedCV" class="form-horizontal" role="form" name="editedCV" autocomplete="off" method="post" action="checkedCVs.php">
								...
								<div class="modal-body">
									...
									echo "	<label id='editCVLabel' class='control-label col-sm-2' for='eCCVeducation'>Educación *: </label>";
									echo "	<div class='col-sm-10'>";
									
									for($contEduc=0; $contEduc<count($arrayEducTittle); $contEduc++){
										echo "	<div class='panel panel-default'>";
										echo "		<div class='panel-heading'>";
										echo "			<h3 class='panel-title'>Educación #".($contEduc+1) . "</h3>";
										echo "		</div>";
										echo "		<div class='panel-body'>";
										echo "			<div class='form-group'>";
										echo "				<label id='editCVLabel' class='control-label col-sm-2' for='eCCVeducTittle$contEduc'>Título: </label>";
										echo " 				<div class='col-sm-10'>";
										echo "					<input class='form-control' type='text' name='eCCVeducTittle$contEduc' value='" . ($arrayEducTittle[$contEduc]) . "' >";
										echo " 				</div>";
										echo "			</div>";
										echo "			<div class='form-group'>";
										echo "				<label id='editCVLabel' class='control-label col-sm-2' for='eCCVeducCenter$contEduc'>Centro: </label>";
										echo " 				<div class='col-sm-10'>";
										echo "					<input class='form-control' type='text' name='eCCVeducCenter$contEduc' value='" . ($arrayEducCenter[$contEduc]) . "' >";
										echo " 				</div>";
										echo "			</div>";
										echo "			<div class='form-group'>";
										echo "				<label id='editCVLabel' class='control-label col-sm-2' for='eCCVeducStart$contEduc'>Inicio: </label>";
										echo " 				<div class='col-sm-4'>";
										echo "					<input class='form-control' type='date' name='eCCVeducStart$contEduc' value='" . ($arrayEducStart[$contEduc]) . "' >";
										echo " 				</div>";
										echo "				<label id='editCVLabel' class='control-label col-sm-2' for='eCCVeducEnd$contEduc'>Fin: </label>";
										echo " 				<div class='col-sm-4'>";
